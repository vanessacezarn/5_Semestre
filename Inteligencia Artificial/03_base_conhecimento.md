...
- linguagem no contexto do PARADIGMA LÓGICO ➜ lógica de 1ª ordem
    - programador implementa o que quer e quando quer
...
- não possui qualquer controle de restrição
    - é extramamente vulnerável a inconsistência de dados, pois ela não verifica se os dados adicionado realmente são verdadeiros.
- baseado em sentenças ou predicados ou assertivas ou cláusulas
    ...
    - dentro de uma sentaça há parâmetros ou argumentos
        - um argumento/parâmetro pode ser: OBJETO, LITERAL, VARIÁVEL
    ...
    - exemplo
        ...
        primos(A,B) :- progenitor(PA,A),    
                        ...
                        irmaos(PA,PB)  
        ```
- está sendo utilizado a plataforma [SWISH](https://swi-prolog.org) 

- Exemplos estudos em aula: 
    - exemplo 1

...
with open("Atividade_RNA/dados_creditos.csv", "r", encoding="utf-8") as arquivo:
    leitor = csv.reader(arquivo, delimiter=",")
    for linha in leitor:
        # Removido o Tab e padronizado com 4 espaços extras
        saida = int(linha[-1])
...
while (True):
	...
	historico_credito = float(input('\nValor para historico de credito: '))
	renda_mensal = float(input('Valor para renda mensal: '))
	print('Ponto: ', historico_credito , ' , ', renda_mensal)
	rede.teste([historico_credito,renda_mensal])
